...
3. 単一ページを取得するためのスクレイプモードを選択します。
4. スクレイプ対象の URL を入力するか、ワークフローの別の箇所から渡します。
5. 取得したいサイトとデータに応じて、Page Options と Extractor Options を設定します。これらはワークフローの別の箇所から渡すこともできます。
6. データをワークフローで活用します。